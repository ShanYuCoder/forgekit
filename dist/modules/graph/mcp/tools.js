...
import { installProjectAssets, projectInstallStatus, } from '../install/project.js';
...
export function registerTools(server) {
    ...
    server.tool('artifactgraph_init', 'Initialize/update config, lexicons, and MCP DNA in the current repository', {
        types: z
    ...
    server.tool('artifactgraph_harness_status', 'Show installed ArtifactGraph MCP DNA types and managed-file drift in the current repo', {}, async () => text(projectInstallStatus(currentProject().root)));
