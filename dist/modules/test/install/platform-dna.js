...
/**
 * Delegate cross-repo CodeGraph ownership to Platform DNA. Testkit never reads
 * project maps or writes `codegraph-*` MCP entries itself.
 */
export function wirePlatformDnaCodegraph(opts) {
    ...
    if (opts.filterKeys?.trim())
        args.push(`--codegraph-repos=${opts.filterKeys.trim()}`);
...
//# sourceMappingURL=platform-dna.js.map