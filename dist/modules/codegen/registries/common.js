...
export function validateCommonRegistry(projectRoot, explicitPath) {
    const registryPath = path.resolve(explicitPath ?? path.join(projectRoot, 'registries', 'common.registry.json'));
    let raw;
    try {
