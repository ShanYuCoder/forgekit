import {
  insertCluster
} from "./chunk-LZBISVB6.js";
import {
  insertEdge,
  insertEdgeLabel,
  markers_default,
  positionEdgeLabel
} from "./chunk-ZDU2ZVVO.js";
import {
  insertNode
} from "./chunk-3DEXLGUA.js";
import {
  labelHelper
} from "./chunk-BMCXI3VV.js";
import {
  interpolateToCurve
...
var registerDefaultLayoutLoaders = __name(() => {
  registerLayoutLoaders([
    {
      name: "dagre",
      loader: __name(async () => await import("./dagre-GXQ25YYZ-3FMG6RFG.js"), "loader")
    },
    {
      name: "swimlane",
      loader: __name(async () => await import("./swimlanes-42K2YHIH-E2VUMBIB.js"), "loader")
    },
    ...true ? [
      {
        name: "cose-bilkent",
        loader: __name(async () => await import("./cose-bilkent-JH36ORCC-MYAZXL2U.js"), "loader")
      }
    ] : []
  ]);
...
//# sourceMappingURL=chunk-3Y7BJDZY.js.map
