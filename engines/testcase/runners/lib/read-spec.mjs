...
export async function readSpecFile(specPath) {
  ...
  if (!spec.codegen?.profile) {
    throw new Error(
      `Missing codegen.profile in ${specPath}. Spec chưa codegen-ready — chạy /grill-dev trước. ` +
        'Xem .cursor/extracts/codegen/readiness.md và templates/spec.yaml trong docs hub'
    )
  }
